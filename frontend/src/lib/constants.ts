...
export const APP_NAME = "pixel_dream_agent";
...
export const ROUTES = {
  ...
  VAULT: "/vault",
  PROJECT_HANDOFFS: (id: string) => `/projects/${id}/handoffs`,
  PROJECT_SECRETS: (id: string) => `/projects/${id}/secrets`,
  PROJECT_INTEGRATIONS: (id: string) => `/projects/${id}/integrations`,
  PROJECT_VAULT: (id: string) => `/projects/${id}/vault`,
} as const;
