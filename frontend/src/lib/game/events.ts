...
export interface GameEventMap {
  ...
  "open-chat": [seatId: string];
  "open-run-task": [seatId: string];
  "agent-menu-open": [payload: { seatId: string; status: string; assignedRunId: string | null; clientX: number; clientY: number }];
