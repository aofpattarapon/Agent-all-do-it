        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? "border-[var(--pix-gold-dark)] bg-[var(--pix-parch-2)]"
                : "border-[var(--pix-wood-dark)] bg-[var(--pix-parch)] hover:bg-[var(--pix-parch-2)]",
            )}
            style={{
              fontFamily: '"Pixelify Sans", sans-serif',
              boxShadow: isActive ? "inset 0 0 0 2px var(--pix-parch)" : "inset 0 0 0 2px var(--pix-parch)",
            }}
          >
            <span
              aria-hidden
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold" style={{ color: "var(--pix-ink)" }}>{p.label}</p>
              <p className="truncate text-xs" style={{ color: "var(--pix-ink-soft)", fontFamily: '"VT323", monospace' }}>{p.description}</p>
            </div>
          </button>
        );
      })}
