...
export class Worker implements WorkerCtx {
  ...
  constructor(
    ...
    const nameY = y + FRAME_HEIGHT / 2 + 4;
    this.nameTag = scene.add
      .text(x, nameY, label, {
        fontFamily: '"VT323", "ark-pixel-12px", monospace',
        fontSize: "16px",
        color: "#ffffff",
    ...
    this.statusDot = scene.add.circle(x - this.nameTag.width / 2 - 8, nameY + 6, 4, 0x888888);
    this.statusDot.setDepth(21);
