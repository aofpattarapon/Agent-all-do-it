...
Run with: `uv run pixel_dream_agent cmd my-command --name test`
...
# Or use CLI
uv run pixel_dream_agent db migrate -m "Add notifications table"
uv run pixel_dream_agent db upgrade
```
