...
|----------|---------|-------------|
| `PROJECT_NAME` | `pixel_dream_agent` | Display name for the project |
...
| `POSTGRES_DB` | `pixel_dream_agent` | Database name |
...
| `LLM_PROVIDER` | `all` | LLM provider (informational) |
...
| `LOGFIRE_SERVICE_NAME` | `pixel_dream_agent` | Service name in Logfire dashboard |
...
| `LANGCHAIN_PROJECT` | `pixel_dream_agent` | Project name in LangSmith |
