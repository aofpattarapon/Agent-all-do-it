...
from app.api.deps import CurrentUser, FileUploadSvc, ProjectSvc
...
async def upload_file(
    ...
    if project_id is not None:
        await project_svc.resolve_access(project_id, current_user, require=Permission.PROJECT_VIEW)
    ...
    return FileUploadResponse(
        ...
        project_id=chat_file.project_id,
    )
