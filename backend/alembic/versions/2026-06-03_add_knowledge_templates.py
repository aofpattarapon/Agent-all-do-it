...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("knowledge_templates_category_idx"), "knowledge_templates", ["category"], unique=False
    )
    op.create_index(
        op.f("knowledge_templates_source_idx"), "knowledge_templates", ["source"], unique=False
    )
    op.create_index(
        op.f("knowledge_templates_source_key_idx"),
        "knowledge_templates",
        ["source_key"],
        unique=True,
    )
    op.create_index(
        op.f("knowledge_templates_subcategory_idx"),
        "knowledge_templates",
        ["subcategory"],
        unique=False,
    )
