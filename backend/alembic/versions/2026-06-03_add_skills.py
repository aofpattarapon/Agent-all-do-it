...
down_revision: Union[str, None] = '9d4e2f1a8c3b'
...
def upgrade() -> None:
    ...
    op.add_column('agent_configs', sa.Column('skill_ids', postgresql.JSONB(astext_type=sa.Text()), server_default='[]', nullable=False))
