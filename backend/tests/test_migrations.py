...
WARNING: downgrade/cycle tests WIPE ALL DATA. They are skipped unless
CI=true is set so they never run against a live developer database.
"""
...
# Destructive migration tests only run in CI environments.
...
class TestMigrations:
    ...
    @pytest.mark.skipif(not _IN_CI, reason="Destructive: wipes all data — only runs in CI (set CI=true)")
